...
class Image extends \ZipMoney\ZipMoneyPayment\Block\AbstractWidget implements CatalogBlock\ShortcutInterface
{   

  const WIDGET_TYPE = "image";
  ...
  {   
    $this->_orderHelper->getCheckout();


    if ($this->_configShow(self::WIDGET_TYPE,$this->getPageType())) {   
      $this->_logger->debug("Rendering Image Widget in ".$this->getPageType()." page");
