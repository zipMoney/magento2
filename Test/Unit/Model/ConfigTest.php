...
class ConfigTest extends \PHPUnit_Framework_TestCase
{
    ...
    {     
        ...
        $this->cacheTypeList = $this->getMock('Magento\Framework\App\Cache\TypeListInterface');        
        
        $this->storeManager = $this->objectManagerHelper->getObject('Magento\Store\Model\StoreManager');

        $this->resourceConfig = $this->getMock('Magento\Config\Model\ResourceModel\Config', [], [], '', false);   

        $this->messageManager = $this->getMock('Magento\Framework\Message\ManagerInterface');
        $this->storeScope = $this->getMock('ZipMoney\ZipMoneyPayment\Model\StoreScope',[], [], '', false);
        $this->apiHelper = $this->getMock('ZipMoney\ZipMoneyPayment\Helper\Api',[], [], '', false);
        $this->logger = $this->getMock('ZipMoney\ZipMoneyPayment\Helper\Logger',[], [], '', false);
    ...
    {
        $this->assertFalse($this->model->isMethodActive('zm_zipcredit',1));
    }
