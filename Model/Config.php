...
class Config implements ConfigInterface
{
     ...
     *
     */
    const PAYMENT_ZIPMONEY_ORDER_STATE = "order_status_settings";
    /**
     * API Envronment
     *
     * @const
    ...
    public function getMerchantOrderState()
    {
        return $this->getConfigData(self::PAYMENT_ZIPMONEY_ORDER_STATE);
    }
